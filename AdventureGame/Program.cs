...
Console.WriteLine("You are a distant family member of a rich millionaire who has just passed, leaving this mansion to you.");
Console.WriteLine("Not that you are the newfound owner, you decide to take a look inside ");
...
if(roomChoice == "living room")
{
    ...
    {
        Console.WriteLine("You attempt to steal the jewelry, but the pitbull wakes and rips you to shreds.");
...
else if(roomChoice == "dining room")
{
    ...
    else if(vaseChoice == "no")
    {
        ...
        Console.WriteLine("As you turb to leave, you hear a cracking sound coming from teh corner");
        Console.WriteLine("A dark figure with glowing red eyes launces at you, knocking you unconcius");
